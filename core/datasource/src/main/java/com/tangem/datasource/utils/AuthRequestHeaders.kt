 ...
 */
internal class AuthenticationHeader(authProvider: AuthProvider) : RequestHeader(
 ...
 */
internal class TangemApiKeyHeader(authProvider: AuthProvider, apiEnvironment: Provider<ApiEnvironment>) : RequestHeader(
