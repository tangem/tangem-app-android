...
object TangemPayTestTags {
    ...
    const val CARD_DETAILS_CARDHOLDER_NAME_VALUE = "TANGEM_PAY_CARD_DETAILS_CARDHOLDER_NAME_VALUE"
    ...
    const val CARD_DETAILS_COPY_CARDHOLDER_NAME = "TANGEM_PAY_CARD_DETAILS_COPY_CARDHOLDER_NAME"
    ...
    const val DELIVERY_CONTACT_SUPPORT_BUTTON = "TANGEM_PAY_DELIVERY_CONTACT_SUPPORT_BUTTON"
    const val DELIVERY_ACTIVATE_BUTTON = "TANGEM_PAY_DELIVERY_ACTIVATE_BUTTON"
    const val DELIVERY_BANNER = "TANGEM_PAY_DELIVERY_BANNER"

    // Plastic card activation
    const val CARD_ACTIVATION_TOP_BAR = "TANGEM_PAY_CARD_ACTIVATION_TOP_BAR"
    const val CARD_ACTIVATION_HINT = "TANGEM_PAY_CARD_ACTIVATION_HINT"
    const val CARD_ACTIVATION_CONTINUE_BUTTON = "TANGEM_PAY_CARD_ACTIVATION_CONTINUE_BUTTON"
    const val CARD_ACTIVATION_INPUT_FIELD = "TANGEM_PAY_CARD_ACTIVATION_INPUT_FIELD"
