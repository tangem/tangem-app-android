...
private var _ic_control_circle_24: ImageVector? = null

val Icons.ic_control_circle_24: ImageVector
    get() {
        if (_ic_control_circle_24 != null) return _ic_control_circle_24!!
        _ic_control_circle_24 = ImageVector.Builder(
            name = "ic_control_circle_24",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f,
        ...
        return _ic_control_circle_24!!
    }

@Composable
@Preview(showBackground = true)
private fun IcControlCircle24Preview() {
    Icon(
