...
object StakingDetailsScreenTestTags {
    ...
    const val ACTIVE_STAKING_PENDING_ICON = "STAKING_DETAILS_ACTIVE_STAKING_PENDING_ICON"
    const val ACTIVE_STAKING_TITLE = "STAKING_DETAILS_ACTIVE_STAKING_TITLE"
    const val ACTIVE_STAKING_SUBTITLE = "STAKING_DETAILS_ACTIVE_STAKING_SUBTITLE"
    const val REWARDS_BLOCK = "STAKING_DETAILS_REWARDS_BLOCK"
}