 ...
 */
interface P2PStakingRepository {
     ...
     */
    suspend fun getVaults(network: P2PNetwork = P2PNetwork.MAINNET): Either<StakingError, List<P2PVault>>
    ...
    suspend fun createDepositTransaction(
        ...
        vaultAddress: String,
        amount: String,
    ): Either<StakingError, P2PUnsignedTransaction>
    ...
    ): Either<StakingError, P2PBroadcastResult>
    ...
    suspend fun getAccountInfo(
        ...
        delegatorAddress: String,
        vaultAddress: String,
    ): Either<StakingError, P2PAccountInfo>
    ...
    suspend fun getRewards(
        ...
        vaultAddress: String,
        period: Int? = null,
    ): Either<StakingError, List<P2PReward>>
}