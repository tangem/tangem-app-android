...
internal class DefaultAddToPortfolioComponent @AssistedInject constructor(
    ...
    private val chooseNetworkComponent: ChooseNetworkComponent = chooseNetworkComponentFactory.create(
        context = child("chooseNetworkComponent"),
        params = ChooseNetworkComponent.Params(
            data = model.selectedPortfolio,
            callbacks = model,
        ),
    )
    ...
    private fun BottomSheetTitle(
        ...
        val title: TextReference = when (stack.active.configuration) {
            ...
            AddToPortfolioRoutes.TokenActions -> stringReference("Get token")
