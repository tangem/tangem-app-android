    ...
    Column(modifier = modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(12.dp)) {
        if (item.isLoading) {
            ...
            if (item.estimatedWalletChanges != null) {
                ...
                ApproveDescription(modifier = Modifier.padding(bottom = 6.dp, start = 12.dp, end = 12.dp))
...
@Composable
private fun ApproveDescription(modifier: Modifier = Modifier) {
        ...
        text = buildAnnotatedString {
            ...
            withLink(
                link = LinkAnnotation.Clickable(
                    ...
                    linkInteractionListener = { Timber.d("ApproveDescription: open blog site") },
                ),
