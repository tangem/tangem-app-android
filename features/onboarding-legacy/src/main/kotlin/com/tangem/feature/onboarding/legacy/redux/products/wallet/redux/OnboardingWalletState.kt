package com.tangem.feature.onboarding.legacy.redux.products.wallet.redux
...
internal data class OnboardingWalletState(
...
sealed class BackupDialog : StateDialog {
    ...
    data object UnfinishedBackupFound : BackupDialog()
    data object ConfirmDiscardingBackup : BackupDialog()
