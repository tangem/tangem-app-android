package com.tangem.feature.onboarding.legacy.analytics
...
internal sealed class Onboarding(
    ...
    sealed class CreateWallet(
        ...
        class WalletCreatedSuccessfully(
            ...
            params = buildMap {
                ...
                if (seedPhraseLength != null) put("Seed Phrase Length", seedPhraseLength.toString())
            },
        )
    }
    ...
    sealed class Topup(
        ...
        class ButtonBuyCrypto(currency: Currency) : Topup(
            event = "Button - Buy Crypto",
            params = mapOf(AnalyticsParam.CURRENCY to currency.currencySymbol),
        )
