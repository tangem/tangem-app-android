...
internal class WalletWarningsClickIntentsImplementor @Inject constructor(
    ...
    override fun onDislikeAppClick() {
        ...
        modelScope.launch(dispatchers.main) {
            ...
            val scanResponse =
                getSelectedUserWallet()?.requireColdWallet()?.scanResponse ?: return@launch // TODO AND-11142
    ...
    override fun onSupportClick() {
        val scanResponse = getSelectedUserWallet()?.requireColdWallet()?.scanResponse ?: return // TODO AND-11142
