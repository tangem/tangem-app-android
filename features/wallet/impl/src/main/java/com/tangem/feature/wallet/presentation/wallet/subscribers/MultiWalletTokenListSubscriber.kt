...
import com.tangem.feature.wallet.presentation.wallet.domain.TokenListFlowsHolder
...
internal class MultiWalletTokenListSubscriber(
    ...
    private val tokenListFlowsHolder: TokenListFlowsHolder,
    ...
    override fun tokenListFlow(coroutineScope: CoroutineScope): LceFlow<TokenListError, TokenList> {
        tokenListFlowsHolder.addIfNot(userWallet.walletId, coroutineScope)

        return tokenListFlowsHolder.getOrThrow(userWallet.walletId)
    }
