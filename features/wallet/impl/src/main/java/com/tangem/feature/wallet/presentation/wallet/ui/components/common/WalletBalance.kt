...
import com.tangem.feature.wallet.presentation.preview.WalletPreviewData2
...
internal fun WalletBalance(
    ...
    isBalanceHidden: Boolean, modifier: Modifier = Modifier,
) {
    Column(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = walletBalanceUM.title.resolveReference(),
...
private fun WalletBalance_Preview(@PreviewParameter(WalletBalancePreviewProvider::class) params: WalletBalanceUM) {
    TangemThemePreviewRedesign {
        WalletBalance(
            ...
            buttons = WalletPreviewData2.actionButtons,
