...
internal class TokensPortfolioUMConverter(
    ...
    private val addButtonState: MyPortfolioUM.Tokens.AddButtonState,
    ...
    private fun toggleQuickActions(cryptoData: PortfolioData.CryptoCurrencyData) {
        updateTokens { tokenList ->
            tokenList.map { portfolioTokenUM ->
                portfolioTokenUM.copy(
                    isQuickActionsShown = if (portfolioTokenUM.matchWith(cryptoData)) {
                        !portfolioTokenUM.isQuickActionsShown
                    } else {
                        false
                    },
                )
