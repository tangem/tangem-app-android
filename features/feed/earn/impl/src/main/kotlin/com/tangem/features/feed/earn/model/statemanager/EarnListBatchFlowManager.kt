...
import com.tangem.features.feed.earn.model.converter.EarnTokenWithCurrencyToTokenRowConverter
...
internal class EarnListBatchFlowManager(
    ...
    private val converter = EarnTokenWithCurrencyToTokenRowConverter(
    ...
    val uiItems: StateFlow<ImmutableList<TangemTokenRow.State.Content>> =
        batchState
            .scan(
                persistentListOf<TangemTokenRow.State.Content>() to -1,
            ) { (accItems, lastProcessedBatchIndex), newState ->
