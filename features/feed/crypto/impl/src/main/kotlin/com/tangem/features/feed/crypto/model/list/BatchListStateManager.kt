...
/**
 * Incrementally maps domain batches to UI batches, converting only the batches (and items) that
 * actually changed. Copy of the old feed's `BatchListStateManager`.
 */
