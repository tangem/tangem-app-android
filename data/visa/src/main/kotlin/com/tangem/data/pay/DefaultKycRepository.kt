...
class DefaultKycRepository @AssistedInject constructor(
    ...
    private val customerWalletAuthRepository: CustomerWalletAuthRepository,
) : KycRepository {
    ...
    override suspend fun getKycStartInfo(address: String, cardId: String): Either<UniversalError, KycStartInfo> {
        val authHeader = customerWalletAuthRepository.generateNewAuthHeader(address, cardId).getOrNull()
