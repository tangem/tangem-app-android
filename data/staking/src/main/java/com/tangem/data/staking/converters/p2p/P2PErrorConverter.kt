...
import com.tangem.datasource.api.p2p.models.response.P2PErrorDetailsDTO
import com.tangem.datasource.api.p2p.models.response.P2PErrorResponse
...
internal object P2PErrorConverter : Converter<P2PErrorResponse, StakingError> {

    override fun convert(value: P2PErrorResponse): StakingError {
        return convertFromErrorDetails(value.error)
    }

    fun convertFromErrorDetails(details: P2PErrorDetailsDTO): StakingError {
