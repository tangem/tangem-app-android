...
import com.tangem.data.staking.DefaultP2PStakingRepository
...
internal object StakingDataModule {
    ...
    @Provides
    @Singleton
    fun provideP2PStakingRepository(p2pApi: P2PApi, dispatchers: CoroutineDispatcherProvider): P2PStakingRepository {
        return DefaultP2PStakingRepository(
            p2pApi = p2pApi,
            dispatchers = dispatchers,
        )
    }
