...
import com.tangem.data.transaction.DefaultYieldLendingTransactionRepository
...
internal object TransactionDataModule {
    ...
    @Provides
    @Singleton
    fun providerYieldLendingTransactionRepository(
        walletManagersFacade: WalletManagersFacade,
        dispatchers: CoroutineDispatcherProvider,
    ): YieldLendingTransactionRepository {
        return DefaultYieldLendingTransactionRepository(
            walletManagersFacade = walletManagersFacade,
            dispatchers = dispatchers,
        )
    }
