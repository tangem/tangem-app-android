...
import com.tangem.store.preferences.adapters.BigDecimalAdapter
import com.tangem.store.preferences.adapters.CardBalanceStateAdapter
import com.tangem.store.preferences.storage.DisclaimerPrefStorage
import com.tangem.store.preferences.storage.FiatCurrenciesPrefStorage
import com.tangem.store.preferences.storage.ToppedUpWalletStorage
import com.tangem.store.preferences.storage.UsedCardsPrefStorage
...
class PreferencesStore @Inject internal constructor(applicationContext: Context) {
