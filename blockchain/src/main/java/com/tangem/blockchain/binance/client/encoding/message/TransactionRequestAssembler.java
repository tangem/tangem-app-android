package com.tangem.blockchain.binance.client.encoding.message;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.google.common.annotations.VisibleForTesting;
import com.google.protobuf.ByteString;
import com.tangem.blockchain.binance.client.Wallet;
...
import com.tangem.blockchain.binance.client.encoding.EncodeUtils;
import com.tangem.blockchain.binance.proto.StdSignature;
import com.tangem.blockchain.binance.proto.StdTx;
...
public class TransactionRequestAssembler {
    ...
    NewOrderMessage createNewOrderMessage(
            com.tangem.blockchain.binance.client.domain.broadcast.NewOrder newOrder) {
    ...
    byte[] encodeNewOrderMessage(NewOrderMessage newOrder)
            throws IOException {
        com.tangem.blockchain.binance.proto.NewOrder proto = com.tangem.blockchain.binance.proto.NewOrder.newBuilder()
    ...
    public RequestBody buildNewOrder(com.tangem.blockchain.binance.client.domain.broadcast.NewOrder newOrder)
    ...
    CancelOrderMessage createCancelOrderMessage(
            com.tangem.blockchain.binance.client.domain.broadcast.CancelOrder cancelOrder) {
    ...
    byte[] encodeCancelOrderMessage(CancelOrderMessage cancelOrder)
            throws IOException {
        com.tangem.blockchain.binance.proto.CancelOrder proto = com.tangem.blockchain.binance.proto.CancelOrder.newBuilder()
                .setSender(ByteString.copyFrom(wallet.getAddressBytes()))
    ...
    public RequestBody buildCancelOrder(com.tangem.blockchain.binance.client.domain.broadcast.CancelOrder cancelOrder)
            throws IOException, NoSuchAlgorithmException {
    ...
    private com.tangem.blockchain.binance.proto.Send.Input toProtoInput(InputOutput input) {
        byte[] address = Crypto.decodeAddress(input.getAddress());
        com.tangem.blockchain.binance.proto.Send.Input.Builder builder =
                com.tangem.blockchain.binance.proto.Send.Input.newBuilder().setAddress(ByteString.copyFrom(address));

        for (Token coin : input.getCoins()) {
            com.tangem.blockchain.binance.proto.Send.Token protCoin =
                    com.tangem.blockchain.binance.proto.Send.Token.newBuilder().setAmount(coin.getAmount())
    ...
    private com.tangem.blockchain.binance.proto.Send.Output toProtoOutput(InputOutput output) {
        byte[] address = Crypto.decodeAddress(output.getAddress());
        com.tangem.blockchain.binance.proto.Send.Output.Builder builder =
                com.tangem.blockchain.binance.proto.Send.Output.newBuilder().setAddress(ByteString.copyFrom(address));
    ...
    byte[] encodeTransferMessage(TransferMessage msg)
            throws IOException {
        com.tangem.blockchain.binance.proto.Send.Builder builder = com.tangem.blockchain.binance.proto.Send.newBuilder();
        ...
        com.tangem.blockchain.binance.proto.Send proto = builder.build();
    ...
    byte[] encodeTokenFreezeMessage(TokenFreezeMessage freeze) throws IOException {
        ...
        com.tangem.blockchain.binance.proto.TokenFreeze proto =
                com.tangem.blockchain.binance.proto.TokenFreeze.newBuilder().setFrom(ByteString.copyFrom(address))
    ...
    byte[] encodeTokenUnfreezeMessage(TokenUnfreezeMessage unfreeze) throws IOException {
        ...
        com.tangem.blockchain.binance.proto.TokenUnfreeze proto =
                com.tangem.blockchain.binance.proto.TokenUnfreeze.newBuilder().setFrom(ByteString.copyFrom(address))
