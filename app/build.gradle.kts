...
dependencies {
    ...
    debugImplementation(projects.features.kyc.web)
    internalImplementation(projects.features.kyc.web)
    mockedImplementation(projects.features.kyc.web)
    releaseImplementation(projects.features.kyc.web)
    externalImplementation(projects.features.kyc.web)
