...
import com.tangem.tap.network.auth.DefaultP2PAuthProvider
...
internal class AuthModule {
    ...
    @Provides
    @Singleton
    fun provideP2PAuthProvider(environmentConfigStorage: EnvironmentConfigStorage): P2PAuthProvider {
        return DefaultP2PAuthProvider(environmentConfigStorage)
    }
