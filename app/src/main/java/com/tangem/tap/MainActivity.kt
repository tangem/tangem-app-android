...
class MainActivity : AppCompatActivity(), SnackbarHandler, ActivityResultCallbackHolder {
    ...
    private fun checkPlatformServicesAvailability() {
        when {
            GoogleServicesHelper.checkGoogleServicesAvailability(this) -> checkGoogleServicesAvailability()
            HuaweiServicesHelper.checkHuaweiServicesAvailability(this) -> checkHuaweiServicesAvailability()
        }
    }
