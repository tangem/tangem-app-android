 ...
 * [CardDTO.BackupStatus.NoBackup]. Same "Tangem 3.0" issuer config as [Wallet3MockContent]; scanning it
 * routes into the "Create a wallet" onboarding screen, then straight into backup (backup cannot be skipped).
 */
object Wallet3NoBackupNoWalletsMockContent : MockContent {
