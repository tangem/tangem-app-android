...
/**
 * Wallet 3 (firmware v8.58+) that has wallets but is NOT backed up yet — [CardDTO.BackupStatus.NoBackup].
 * Same "Tangem 3.0" issuer config as [Wallet3MockContent]; scanning it routes straight into the
 * "Creating a backup" onboarding screen (backup cannot be skipped).
 */
object Wallet3NoBackupMockContent : MockContent {
