            ...
            with(uiState.form) {
                ...
                when (isValid) {
                    is ContractAddressValidatorResult.Success -> {
                        ...
                        // TODO("AND-3464 Add loading custom token information")
                    }
                ...
                // TODO("AND-3469 Update warnings")
                // TODO("AND-3469 Update floating button")
            }
        }
