...
/**
 * @property isEnabledOnCard Indicates whether access code recovery is enabled on the card
 * @property isEnabledSelection Represents the currently selected option in the app (not yet saved on the card)
...
data class AccessCodeRecoveryScreenState(
    val isEnabledOnCard: Boolean,
    val isEnabledSelection: Boolean,
