...
abstract class BaseOnboardingFragment<T> : BaseStoreFragment(R.layout.fragment_onboarding_main), StoreSubscriber<T> {
    ...
    protected val binding: FragmentOnboardingMainBinding by viewBinding(
        FragmentOnboardingMainBinding::bind,
    )
    protected val pbBinding: ViewOnboardingProgressBinding by viewBinding(
