...
class PendingTransactionsAdapter :
    ListAdapter<PendingTransaction, PendingTransactionsAdapter.TransactionsViewHolder>(
        DiffUtilCallback,
    ) {
    ...
    class TransactionsViewHolder(val binding: ItemPendingTransactionBinding) :
        ...
        fun bind(transaction: PendingTransaction) {
            ...
            binding.ivPendingTransaction.setImageDrawable(
                binding.root.context.getDrawableCompat(image),
            )
        }
    }
}
